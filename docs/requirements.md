...
## 목표
- RSS 기반 뉴스 수집 → 요약·감성 분석 → 웹에서 검색/필터/열람.
...
## 기능 요구
- RSS 소스 관리: 소스 추가/비활성, 마지막 수집 시각 저장.
- 수집/정규화: 본문 추출, HTML/태그 제거, 중복 제거.
